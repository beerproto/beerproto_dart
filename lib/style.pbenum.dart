...
class StyleCategories extends $pb.ProtobufEnum {
  ...
  static final $core.List<StyleCategories?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 7);
  static StyleCategories? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
