...
class VarietyInformationType extends $pb.ProtobufEnum {
  ...
  static final $core.List<VarietyInformationType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 7);
  static VarietyInformationType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class HopVarietyBaseForm extends $pb.ProtobufEnum {
  ...
  static final $core.List<HopVarietyBaseForm?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 6);
  static HopVarietyBaseForm? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class IBUMethodUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<IBUMethodUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static IBUMethodUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
