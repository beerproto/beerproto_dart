...
class MashStepType extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set stepTime($0.TimeType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set rampTime($0.TimeType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set endTemperature($0.TemperatureType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set infuseTemperature($0.TemperatureType v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set startPh($0.AcidityType v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set endPh($0.AcidityType v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(11)
  set amount($0.VolumeType v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set stepTemperature($0.TemperatureType v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set waterGrainRatio($0.SpecificVolumeType v) { setField(13, v); }
  @$pb.TagNumber(13)
