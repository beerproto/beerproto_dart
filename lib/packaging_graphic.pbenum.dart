...
class PackagingGraphicType_PositionUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<PackagingGraphicType_PositionUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 8);
  static PackagingGraphicType_PositionUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class PackagingGraphicType_GraphicType extends $pb.ProtobufEnum {
  ...
  static final $core.List<PackagingGraphicType_GraphicType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 11);
  static PackagingGraphicType_GraphicType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class PackagingGraphicType_UnitsType extends $pb.ProtobufEnum {
  ...
  static final $core.List<PackagingGraphicType_UnitsType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static PackagingGraphicType_UnitsType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
