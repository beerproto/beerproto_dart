...
class DiastaticPowerUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<DiastaticPowerUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static DiastaticPowerUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class TemperatureUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<TemperatureUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static TemperatureUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class AcidityUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<AcidityUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static AcidityUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class TimeUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<TimeUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 5);
  static TimeUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class ColorUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<ColorUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static ColorUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class CarbonationUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<CarbonationUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 2);
  static CarbonationUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class BitternessUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<BitternessUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static BitternessUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class GravityUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<GravityUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static GravityUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class SpecificHeatUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<SpecificHeatUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static SpecificHeatUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class ConcentrationUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<ConcentrationUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static ConcentrationUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class SpecificVolumeUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<SpecificVolumeUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 8);
  static SpecificVolumeUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class UnitUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<UnitUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 5);
  static UnitUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class PercentUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<PercentUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 1);
  static PercentUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class ViscosityUnit extends $pb.ProtobufEnum {
  ...
  /// P
  static const ViscosityUnit VISCOSITY_UNIT_POISE = ViscosityUnit._(3, _omitEnumNames ? '' : 'VISCOSITY_UNIT_POISE');
  ...
  static final $core.List<ViscosityUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static ViscosityUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const ViscosityUnit._(super.value, super.name);
}

class RateUnit extends $pb.ProtobufEnum {
  static const RateUnit RATE_UNIT_UNSPECIFIED = RateUnit._(0, _omitEnumNames ? '' : 'RATE_UNIT_UNSPECIFIED');
  /// Volume-based rates
  static const RateUnit RATE_UNIT_L_PER_HOUR = RateUnit._(1, _omitEnumNames ? '' : 'RATE_UNIT_L_PER_HOUR');
  static const RateUnit RATE_UNIT_L_PER_MINUTE = RateUnit._(2, _omitEnumNames ? '' : 'RATE_UNIT_L_PER_MINUTE');
  static const RateUnit RATE_UNIT_GAL_PER_HOUR = RateUnit._(3, _omitEnumNames ? '' : 'RATE_UNIT_GAL_PER_HOUR');
  ...
  static const RateUnit RATE_UNIT_L_PER_KG = RateUnit._(5, _omitEnumNames ? '' : 'RATE_UNIT_L_PER_KG');
  static const RateUnit RATE_UNIT_GAL_PER_LB = RateUnit._(6, _omitEnumNames ? '' : 'RATE_UNIT_GAL_PER_LB');
  /// Temperature change rates (useful for step mashes)
  static const RateUnit RATE_UNIT_C_PER_MINUTE = RateUnit._(7, _omitEnumNames ? '' : 'RATE_UNIT_C_PER_MINUTE');
  static const RateUnit RATE_UNIT_F_PER_MINUTE = RateUnit._(8, _omitEnumNames ? '' : 'RATE_UNIT_F_PER_MINUTE');
  ...
  static final $core.List<RateUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 8);
...
class PressureUnit extends $pb.ProtobufEnum {
  static const PressureUnit PRESSURE_UNIT_UNSPECIFIED = PressureUnit._(0, _omitEnumNames ? '' : 'PRESSURE_UNIT_UNSPECIFIED');
  static const PressureUnit PRESSURE_UNIT_PASCAL = PressureUnit._(1, _omitEnumNames ? '' : 'PRESSURE_UNIT_PASCAL');
  static const PressureUnit PRESSURE_UNIT_BAR = PressureUnit._(2, _omitEnumNames ? '' : 'PRESSURE_UNIT_BAR');
  static const PressureUnit PRESSURE_UNIT_PSI = PressureUnit._(3, _omitEnumNames ? '' : 'PRESSURE_UNIT_PSI');
  static const PressureUnit PRESSURE_UNIT_KPA = PressureUnit._(4, _omitEnumNames ? '' : 'PRESSURE_UNIT_KPA');
  ...
  static final $core.List<PressureUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 4);
  static PressureUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class EnzymeActivityUnit extends $pb.ProtobufEnum {
  static const EnzymeActivityUnit ENZYME_ACTIVITY_UNIT_UNSPECIFIED = EnzymeActivityUnit._(0, _omitEnumNames ? '' : 'ENZYME_ACTIVITY_UNIT_UNSPECIFIED');
  /// Dextrinizing Units (ASBC method, most common for alpha amylase)
  static const EnzymeActivityUnit ENZYME_ACTIVITY_UNIT_DU = EnzymeActivityUnit._(1, _omitEnumNames ? '' : 'ENZYME_ACTIVITY_UNIT_DU');
  /// Windisch–Kolbach units (more common in European malt specs)
  static const EnzymeActivityUnit ENZYME_ACTIVITY_UNIT_WK = EnzymeActivityUnit._(2, _omitEnumNames ? '' : 'ENZYME_ACTIVITY_UNIT_WK');
  /// SKB units (Sandstedt–Kneen–Blish, older standard)
  static const EnzymeActivityUnit ENZYME_ACTIVITY_UNIT_SKB = EnzymeActivityUnit._(3, _omitEnumNames ? '' : 'ENZYME_ACTIVITY_UNIT_SKB');
  ...
  static final $core.List<EnzymeActivityUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static EnzymeActivityUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];

  const EnzymeActivityUnit._(super.value, super.name);
}

class EnzymeType extends $pb.ProtobufEnum {
  static const EnzymeType ENZYME_TYPE_UNSPECIFIED = EnzymeType._(0, _omitEnumNames ? '' : 'ENZYME_TYPE_UNSPECIFIED');
  static const EnzymeType ENZYME_TYPE_ALPHA_AMYLASE = EnzymeType._(1, _omitEnumNames ? '' : 'ENZYME_TYPE_ALPHA_AMYLASE');
  static const EnzymeType ENZYME_TYPE_BETA_AMYLASE = EnzymeType._(2, _omitEnumNames ? '' : 'ENZYME_TYPE_BETA_AMYLASE');
  static const EnzymeType ENZYME_TYPE_PROTEASE = EnzymeType._(3, _omitEnumNames ? '' : 'ENZYME_TYPE_PROTEASE');
  ...
  static final $core.List<EnzymeType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 3);
  static EnzymeType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
