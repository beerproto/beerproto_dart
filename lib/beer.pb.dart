...
import 'equipment.pb.dart' as $18;
...
class Recipe extends $pb.GeneratedMessage {
  factory Recipe({
    $core.String? id,
    $core.Iterable<$10.MashProcedureType>? mashes,
    $core.Iterable<$17.RecipeType>? recipes,
    $core.Iterable<$13.MiscellaneousType>? miscellaneousIngredients,
    $core.Iterable<$7.StyleType>? styles,
    $core.Iterable<$9.FermentationProcedureType>? fermentations,
    $core.Iterable<$12.BoilProcedureType>? boil,
    $core.double? version,
    $core.Iterable<$16.FermentableType>? fermentables,
    $core.Iterable<$14.CultureInformation>? cultures,
    $core.Iterable<$18.EquipmentType>? equipments,
    $core.Iterable<$11.PackagingProcedureType>? packaging,
    $core.Iterable<$8.VarietyInformation>? hopVarieties,
    $core.Iterable<$15.WaterBase>? profiles,
  }) {
    final $result = create();
    if (id != null) {
      $result.id = id;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Recipe', package: const $pb.PackageName(_omitMessageNames ? '' : 'beerproto.v1'), createEmptyInstance: create)
    ...
    ..pc<$10.MashProcedureType>(2, _omitFieldNames ? '' : 'mashes', $pb.PbFieldType.PM, subBuilder: $10.MashProcedureType.create)
    ..pc<$17.RecipeType>(3, _omitFieldNames ? '' : 'recipes', $pb.PbFieldType.PM, subBuilder: $17.RecipeType.create)
    ..pc<$13.MiscellaneousType>(4, _omitFieldNames ? '' : 'miscellaneousIngredients', $pb.PbFieldType.PM, subBuilder: $13.MiscellaneousType.create)
    ..pc<$7.StyleType>(5, _omitFieldNames ? '' : 'styles', $pb.PbFieldType.PM, subBuilder: $7.StyleType.create)
    ..pc<$9.FermentationProcedureType>(6, _omitFieldNames ? '' : 'fermentations', $pb.PbFieldType.PM, subBuilder: $9.FermentationProcedureType.create)
    ..pc<$12.BoilProcedureType>(7, _omitFieldNames ? '' : 'boil', $pb.PbFieldType.PM, subBuilder: $12.BoilProcedureType.create)
    ..a<$core.double>(8, _omitFieldNames ? '' : 'version', $pb.PbFieldType.OD)
    ..pc<$16.FermentableType>(9, _omitFieldNames ? '' : 'fermentables', $pb.PbFieldType.PM, subBuilder: $16.FermentableType.create)
    ..pc<$14.CultureInformation>(10, _omitFieldNames ? '' : 'cultures', $pb.PbFieldType.PM, subBuilder: $14.CultureInformation.create)
    ..pc<$18.EquipmentType>(11, _omitFieldNames ? '' : 'equipments', $pb.PbFieldType.PM, subBuilder: $18.EquipmentType.create)
    ..pc<$11.PackagingProcedureType>(12, _omitFieldNames ? '' : 'packaging', $pb.PbFieldType.PM, subBuilder: $11.PackagingProcedureType.create)
    ..pc<$8.VarietyInformation>(13, _omitFieldNames ? '' : 'hopVarieties', $pb.PbFieldType.PM, subBuilder: $8.VarietyInformation.create)
    ..pc<$15.WaterBase>(14, _omitFieldNames ? '' : 'profiles', $pb.PbFieldType.PM, subBuilder: $15.WaterBase.create)
  ...
  @$pb.TagNumber(2)
  $core.List<$10.MashProcedureType> get mashes => $_getList(1);
  ...
  @$pb.TagNumber(9)
  $core.List<$16.FermentableType> get fermentables => $_getList(8);

  /// Records detailing the wide array of unique cultures
  @$pb.TagNumber(10)
  $core.List<$14.CultureInformation> get cultures => $_getList(9);

  /// Provides necessary information for brewing equipment
  @$pb.TagNumber(11)
  $core.List<$18.EquipmentType> get equipments => $_getList(10);

  /// A collection of steps providing process information for common packaging procedures
  @$pb.TagNumber(12)
  $core.List<$11.PackagingProcedureType> get packaging => $_getList(11);

  /// Records detailing the many properties of unique hop varieties
  @$pb.TagNumber(13)
  $core.List<$8.VarietyInformation> get hopVarieties => $_getList(12);

  /// Records for water profiles used in brewing
  @$pb.TagNumber(14)
  $core.List<$15.WaterBase> get profiles => $_getList(13);
}
