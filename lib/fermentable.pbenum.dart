...
class FermentableBaseType extends $pb.ProtobufEnum {
  ...
  static final $core.List<FermentableBaseType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 8);
  static FermentableBaseType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
