...
class FermentableType extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FermentableType', package: const $pb.PackageName(_omitMessageNames ? '' : 'beerproto.v1'), createEmptyInstance: create)
    ...
    ..aOM<$0.PercentType>(2, _omitFieldNames ? '' : 'maxInBatch', subBuilder: $0.PercentType.create)
    ..aOB(3, _omitFieldNames ? '' : 'recommendMash')
    ..aOM<$0.PercentType>(4, _omitFieldNames ? '' : 'protein', subBuilder: $0.PercentType.create)
    ...
    ..aOM<$0.ColorType>(11, _omitFieldNames ? '' : 'color', subBuilder: $0.ColorType.create)
    ..aOS(12, _omitFieldNames ? '' : 'name')
    ..aOM<$0.DiastaticPowerType>(13, _omitFieldNames ? '' : 'diastaticPower', subBuilder: $0.DiastaticPowerType.create)
    ..aOM<$0.PercentType>(14, _omitFieldNames ? '' : 'moisture', subBuilder: $0.PercentType.create)
    ...
    ..aOM<$0.PercentType>(17, _omitFieldNames ? '' : 'kolbachIndex', subBuilder: $0.PercentType.create)
    ..aOM<$0.PercentType>(18, _omitFieldNames ? '' : 'glassy', subBuilder: $0.PercentType.create)
    ..aOM<$0.PercentType>(19, _omitFieldNames ? '' : 'plump', subBuilder: $0.PercentType.create)
    ..aOM<$0.PercentType>(20, _omitFieldNames ? '' : 'half', subBuilder: $0.PercentType.create)
    ..aOM<$0.PercentType>(21, _omitFieldNames ? '' : 'mealy', subBuilder: $0.PercentType.create)
    ..aOM<$0.PercentType>(22, _omitFieldNames ? '' : 'thru', subBuilder: $0.PercentType.create)
    ..aOM<$0.PercentType>(23, _omitFieldNames ? '' : 'friability', subBuilder: $0.PercentType.create)
    ..aOM<$0.AcidityType>(24, _omitFieldNames ? '' : 'diPh', subBuilder: $0.AcidityType.create)
    ..aOM<$0.ViscosityType>(25, _omitFieldNames ? '' : 'viscosity', subBuilder: $0.ViscosityType.create)
    ..aOM<$0.ConcentrationType>(26, _omitFieldNames ? '' : 'dmsP', subBuilder: $0.ConcentrationType.create)
    ..aOM<$0.ConcentrationType>(27, _omitFieldNames ? '' : 'fan', subBuilder: $0.ConcentrationType.create)
    ..aOM<$0.PercentType>(28, _omitFieldNames ? '' : 'fermentability', subBuilder: $0.PercentType.create)
    ..aOM<$0.ConcentrationType>(29, _omitFieldNames ? '' : 'betaGlucan', subBuilder: $0.ConcentrationType.create)
  ...
  @$pb.TagNumber(2)
  $0.PercentType get maxInBatch => $_getN(1);
  @$pb.TagNumber(2)
  set maxInBatch($0.PercentType v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMaxInBatch() => $_has(1);
  @$pb.TagNumber(2)
  void clearMaxInBatch() => clearField(2);
  @$pb.TagNumber(2)
  $0.PercentType ensureMaxInBatch() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $0.PercentType get protein => $_getN(3);
  @$pb.TagNumber(4)
  set protein($0.PercentType v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasProtein() => $_has(3);
  @$pb.TagNumber(4)
  void clearProtein() => clearField(4);
  @$pb.TagNumber(4)
  $0.PercentType ensureProtein() => $_ensure(3);
  ...
  @$pb.TagNumber(11)
  $0.ColorType get color => $_getN(10);
  @$pb.TagNumber(11)
  set color($0.ColorType v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasColor() => $_has(10);
  @$pb.TagNumber(11)
  void clearColor() => clearField(11);
  @$pb.TagNumber(11)
  $0.ColorType ensureColor() => $_ensure(10);
  ...
  @$pb.TagNumber(13)
  $0.DiastaticPowerType get diastaticPower => $_getN(12);
  @$pb.TagNumber(13)
  set diastaticPower($0.DiastaticPowerType v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasDiastaticPower() => $_has(12);
  @$pb.TagNumber(13)
  void clearDiastaticPower() => clearField(13);
  @$pb.TagNumber(13)
  $0.DiastaticPowerType ensureDiastaticPower() => $_ensure(12);

  @$pb.TagNumber(14)
  $0.PercentType get moisture => $_getN(13);
  @$pb.TagNumber(14)
  set moisture($0.PercentType v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasMoisture() => $_has(13);
  @$pb.TagNumber(14)
  void clearMoisture() => clearField(14);
  @$pb.TagNumber(14)
  $0.PercentType ensureMoisture() => $_ensure(13);
  ...
  @$pb.TagNumber(17)
  $0.PercentType get kolbachIndex => $_getN(16);
  @$pb.TagNumber(17)
  set kolbachIndex($0.PercentType v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasKolbachIndex() => $_has(16);
  @$pb.TagNumber(17)
  void clearKolbachIndex() => clearField(17);
  @$pb.TagNumber(17)
  $0.PercentType ensureKolbachIndex() => $_ensure(16);

  /// Used to indicate the 'crystallized' percentage of starches for crystal malts.
  @$pb.TagNumber(18)
  $0.PercentType get glassy => $_getN(17);
  @$pb.TagNumber(18)
  set glassy($0.PercentType v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasGlassy() => $_has(17);
  @$pb.TagNumber(18)
  void clearGlassy() => clearField(18);
  @$pb.TagNumber(18)
  $0.PercentType ensureGlassy() => $_ensure(17);
  ...
  @$pb.TagNumber(19)
  $0.PercentType get plump => $_getN(18);
  @$pb.TagNumber(19)
  set plump($0.PercentType v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasPlump() => $_has(18);
  @$pb.TagNumber(19)
  void clearPlump() => clearField(19);
  @$pb.TagNumber(19)
  $0.PercentType ensurePlump() => $_ensure(18);

  @$pb.TagNumber(20)
  $0.PercentType get half => $_getN(19);
  @$pb.TagNumber(20)
  set half($0.PercentType v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasHalf() => $_has(19);
  @$pb.TagNumber(20)
  void clearHalf() => clearField(20);
  @$pb.TagNumber(20)
  $0.PercentType ensureHalf() => $_ensure(19);
  ...
  @$pb.TagNumber(23)
  $0.PercentType get friability => $_getN(22);
  @$pb.TagNumber(23)
  set friability($0.PercentType v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasFriability() => $_has(22);
  @$pb.TagNumber(23)
  void clearFriability() => clearField(23);
  @$pb.TagNumber(23)
  $0.PercentType ensureFriability() => $_ensure(22);
  ...
  @$pb.TagNumber(24)
  $0.AcidityType get diPh => $_getN(23);
  @$pb.TagNumber(24)
  set diPh($0.AcidityType v) { setField(24, v); }
  @$pb.TagNumber(24)
  $core.bool hasDiPh() => $_has(23);
  @$pb.TagNumber(24)
  void clearDiPh() => clearField(24);
  @$pb.TagNumber(24)
  $0.AcidityType ensureDiPh() => $_ensure(23);
  ...
  @$pb.TagNumber(25)
  $0.ViscosityType get viscosity => $_getN(24);
  @$pb.TagNumber(25)
  set viscosity($0.ViscosityType v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasViscosity() => $_has(24);
  @$pb.TagNumber(25)
  void clearViscosity() => clearField(25);
  @$pb.TagNumber(25)
  $0.ViscosityType ensureViscosity() => $_ensure(24);
...
class FermentableAdditionType extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FermentableAdditionType', package: const $pb.PackageName(_omitMessageNames ? '' : 'beerproto.v1'), createEmptyInstance: create)
    ...
    ..aOM<$0.ColorType>(6, _omitFieldNames ? '' : 'color', subBuilder: $0.ColorType.create)
  ...
  @$pb.TagNumber(6)
  $0.ColorType get color => $_getN(5);
  @$pb.TagNumber(6)
  set color($0.ColorType v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasColor() => $_has(5);
  @$pb.TagNumber(6)
  void clearColor() => clearField(6);
  @$pb.TagNumber(6)
  $0.ColorType ensureColor() => $_ensure(5);
...
class YieldType extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set fineGrind($0.PercentType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set coarseGrind($0.PercentType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set fineCoarseDifference($0.PercentType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set potential($0.GravityType v) { setField(4, v); }
  @$pb.TagNumber(4)
