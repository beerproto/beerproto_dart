...
class QualitativeRangeUnit extends $pb.ProtobufEnum {
  ...
  static final $core.List<QualitativeRangeUnit?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 7);
  static QualitativeRangeUnit? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class CultureBaseForm extends $pb.ProtobufEnum {
  ...
  static final $core.List<CultureBaseForm?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 5);
  static CultureBaseForm? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class CultureBaseType extends $pb.ProtobufEnum {
  ...
  static const CultureBaseType CULTURE_BASE_TYPE_NON_SACCHAROMYCES = CultureBaseType._(14, _omitEnumNames ? '' : 'CULTURE_BASE_TYPE_NON_SACCHAROMYCES');
  /// Bacteria
  ...
  static const CultureBaseType CULTURE_BASE_TYPE_ACETIC = CultureBaseType._(15, _omitEnumNames ? '' : 'CULTURE_BASE_TYPE_ACETIC');
  ...
  static const CultureBaseType CULTURE_BASE_TYPE_SCOBY = CultureBaseType._(17, _omitEnumNames ? '' : 'CULTURE_BASE_TYPE_SCOBY');
  /// Other biological agents
  static const CultureBaseType CULTURE_BASE_TYPE_MOLD = CultureBaseType._(16, _omitEnumNames ? '' : 'CULTURE_BASE_TYPE_MOLD');
  /// Fallback
  ...
  static final $core.List<CultureBaseType?> _byValue = $pb.ProtobufEnum.$_initByValueList(values, 17);
  static CultureBaseType? valueOf($core.int value) =>  value < 0 || value >= _byValue.length ? null : _byValue[value];
